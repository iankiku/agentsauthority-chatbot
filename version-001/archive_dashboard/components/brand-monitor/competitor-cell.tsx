				...
				<div className="flex items-center gap-1.5">
					{url && !isOwn ? (
						<a
							...
							className={`text-sm font-medium hover:underline ${isOwn ? "text-light-orange" : "text-gray-900 hover:text-light-blue"} flex items-center gap-1`}
						...
						<h3
							className={`text-sm font-medium ${isOwn ? "text-light-orange" : "text-gray-900"}`}
						>
							{name}
						</h3>
					)}
