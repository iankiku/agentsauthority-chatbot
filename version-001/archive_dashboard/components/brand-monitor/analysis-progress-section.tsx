...
import { AnalysisStage, Company } from "@/lib/types";
					...
					<Card className="p-2 bg-card text-card-foreground gap-6 rounded-xl border py-6 shadow-sm border-gray-200 h-full flex flex-col">
						<CardHeader className="pb-4">
							...
							{scrapingCompetitors && !analyzing && (
								<CardDescription className="mt-2 flex items-center justify-center gap-2 text-light-orange">
									<Loader2 className="w-4 h-4 animate-spin text-light-orange" />
							...
							{analyzing && analysisProgress && (
								<div className="mt-4">
									...
									<div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
										<div
											className="bg-light-orange h-2 rounded-full transition-all duration-500 ease-out"
															...
															>
																...
																{analyzing && (
																	<>
																		...
																		{status === "completed" && (
																			<CheckIcon className="w-4 h-4 text-light-orange" />
																		)}
																		{status === "failed" && (
