...
const statusIcons = {
	...
	running: <Loader2 className="h-4 w-4 animate-spin text-light-blue" />,
	completed: <CheckCircle2 className="h-4 w-4 text-light-orange" />,
	failed: <XCircle className="h-4 w-4 text-gray-500" />,
};
