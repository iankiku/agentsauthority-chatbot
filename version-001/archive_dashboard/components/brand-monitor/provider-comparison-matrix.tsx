...
export function ProviderComparisonMatrix({
	...
	return (
		<div className="overflow-x-auto rounded-lg border border-white-200">
			<table className="w-full border-collapse">
				<thead>
					<tr>
						<th className="bg-white-50 border-b border-r border-white-200 w-[180px]">
							<button
								onClick={() => handleSort("competitor")}
								className="w-full p-3 font-medium text-gray-900 flex items-center justify-between hover:bg-white-100 transition-colors text-left"
							>
								Competitors
